 ...
 */
@interface NSBundle (CategoryKit)

/**
 An array of NSNumber objects, shows the best order for path scale search.
 e.g. iPhone3GS:@[@1,@2,@3] iPhone5:@[@2,@3,@1]  iPhone6 Plus:@[@3,@2,@1]
 */
+ (nonnull NSArray<NSNumber *> *)preferredScales;
 ...
 */
+ (nullable NSString *)pathForScaledResource:(nullable NSString *)name
                                      ofType:(nullable NSString *)ext
                                 inDirectory:(nonnull NSString *)bundlePath;
...
- (nullable NSString *)pathForScaledResource:(nullable NSString *)name
                                      ofType:(nullable NSString *)ext
                                 inDirectory:(nonnull NSString *)subpath;
