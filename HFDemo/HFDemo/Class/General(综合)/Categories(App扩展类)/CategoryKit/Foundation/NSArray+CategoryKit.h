 ...
 */
+ (nullable NSArray *)arrayWithPlistData:(nonnull NSData *)plist;
 ...
 */
@interface NSMutableArray (CategoryKit)

///插入对象
- (void)insertNullableObject:(nullable id)anObject atIndex:(NSUInteger)index;
/**
 Creates and returns an array from a specified property list data.
 ...
 @return A new array created from the plist data, or nil if an error occurs.
 */
+ (nullable NSMutableArray *)arrayWithPlistData:(nonnull NSData *)plist;
 ...
 */
- (void)appendObject:(nullable id)anObject;
...
/**
 ...
 This value must not be nil. Raises an NSInvalidArgumentException if anObject is nil.
 */
- (void)prependObject:(nullable id)anObject;
