...
@implementation NSArray (CategoryKit)
...
@implementation NSMutableArray (CategoryKit)


- (void)insertNullableObject:(id)anObject atIndex:(NSUInteger)index {
...
- (void)prependObject:(id)anObject {
    [self insertNullableObject:anObject atIndex:0];
}
