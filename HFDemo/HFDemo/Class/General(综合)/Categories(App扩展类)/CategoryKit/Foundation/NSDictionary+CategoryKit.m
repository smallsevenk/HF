...
#import "NSDictionary+CategoryKit.h"
#import "NSString+CategoryKit.h"
#import "NSData+CategoryKit.h"



@interface _XMLDictionaryParserCategoryKit : NSObject <NSXMLParserDelegate>
@end

@implementation _XMLDictionaryParserCategoryKit {
...
@implementation NSDictionary (CategoryKit)
...
+ (NSDictionary *)dictionaryWithXML:(id)xml {
    _XMLDictionaryParserCategoryKit *parser = nil;
    if ([xml isKindOfClass:[NSString class]]) {
        parser = [[_XMLDictionaryParserCategoryKit alloc] initWithString:xml];
    } else if ([xml isKindOfClass:[NSData class]]) {
        parser = [[_XMLDictionaryParserCategoryKit alloc] initWithData:xml];
    }
...
@implementation NSMutableDictionary (CategoryKit)

- (void)setObjectOrNilObject:(id)anObject forKey:(id<NSCopying>)aKey
{
    if (aKey != nil && anObject != nil) {
        [self setObject:anObject forKey:aKey];
    }
    else {
        //XJLog(@"key:%@:--value:%@",aKey,anObject);
    }
}

///if anObject nil, do @"",  if aKey nil do nothing
- (void)setSafeString:(NSString *)aString forKey:(nullable id<NSCopying>)aKey
{
    if (aKey == nil)
        return;
...
- (void)setSafeArray:(NSArray *)array forKey:(id<NSCopying>)aKey
{
    if (aKey == nil)
        return;
    [self setObject:array ? : @[] forKey:aKey];
}
- (void)setSafeDictionary:(NSDictionary *)dictionary forKey:(id<NSCopying>)aKey
{
    if (aKey == nil)
        return;
...
- (void)setChar:(char)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithChar:value] forKey:aKey];
}

- (void)setUnsignedChar:(unsigned char)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithUnsignedChar:value] forKey:aKey];
}

- (void)setShort:(short)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithShort:value] forKey:aKey];
}

- (void)setUnsignedShort:(unsigned short)value forKey:(id<NSCopying>)aKey
{
...
{
    [self setObjectOrNilObject:[NSNumber numberWithInt:value] forKey:aKey];
}

- (void)setUnsignedInt:(unsigned int)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithUnsignedInt:value] forKey:aKey];
}

- (void)setLong:(long)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithLong:value] forKey:aKey];
}

- (void)setUnsignedLong:(unsigned long)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithUnsignedLong:value] forKey:aKey];
}

- (void)setLongLong:(long long)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithLongLong:value] forKey:aKey];
}

- (void)setUnsignedLongLong:(unsigned long long)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithUnsignedLongLong:value] forKey:aKey];
}

- (void)setFloat:(float)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithFloat:value] forKey:aKey];
}

- (void)setDouble:(double)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithDouble:value] forKey:aKey];
}

- (void)setBool:(BOOL)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithBool:value] forKey:aKey];
}

- (void)setInteger:(NSInteger)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithInteger:value] forKey:aKey];
}

- (void)setUnsignedInteger:(NSUInteger)value forKey:(id<NSCopying>)aKey
{
    [self setObjectOrNilObject:[NSNumber numberWithUnsignedInteger:value] forKey:aKey];
}


+ (nonnull id)mutableDictionaryWithDictionary:(NSDictionary *)dictonay
{
    if (dictonay == nil) {
        return [NSMutableDictionary dictionary];
    }

    if ([dictonay isKindOfClass:[NSDictionary class]]) {
        return [NSMutableDictionary dictionaryWithDictionary:dictonay];
    }
    else {
        return [NSMutableDictionary dictionary];
    }
