...
//  CategoryKit
//
//  Created by smallsevenk on 15/8/25.
...
//image 类型
- (nullable NSString *)contentTypeForImage;
...
/**
 ...
 @param key  The hmac key.
 */
- (nullable NSData *)hmacMD5DataWithKey:(nonnull NSData *)key;
...
/**
 ...
 @param key  The hmac key.
 */
- (nullable NSData *)hmacSHA1DataWithKey:(nonnull NSData *)key;
...
/**
 ...
 @param key  The hmac key.
 */
- (nullable NSData *)hmacSHA224DataWithKey:(nonnull NSData *)key;
...
/**
 ...
 @param key  The hmac key.
 */
- (nullable NSData *)hmacSHA256DataWithKey:(nonnull NSData *)key;
...
/**
 ...
 @param key  The hmac key.
 */
- (nullable NSData *)hmacSHA384DataWithKey:(nonnull NSData *)key;
...
/**
 ...
 @param key  The hmac key.
 */
- (nullable NSData *)hmacSHA512DataWithKey:(nonnull NSData *)key;
