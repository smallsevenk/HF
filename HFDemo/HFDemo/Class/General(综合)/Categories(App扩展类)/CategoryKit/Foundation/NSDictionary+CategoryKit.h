 ...
 */
@interface NSDictionary (CategoryKit)
...
- (nullable NSNumber *)numberValueForKey:(nullable NSString *)key default:(nullable NSNumber *)def;
- (nullable NSString *)stringValueForKey:(nullable NSString *)key default:(nullable NSString *)def;
 ...
 */
@interface NSMutableDictionary (CategoryKit)
///if anObject Or aKey nil , do nothing
- (void)setObjectOrNilObject:(nullable id)anObject forKey:(nullable id<NSCopying>)aKey;
///if anObject nil, do @"",  if aKey nil do nothing
- (void)setSafeString:(nullable NSString *)aString forKey:(nullable id<NSCopying>)aKey;
///if anObject nil, do @[],  if aKey nil do nothing
- (void)setSafeArray:(nullable NSArray *)array forKey:(nullable id<NSCopying>)aKey;
///if anObject nil, do @{},  if aKey nil do nothing
- (void)setSafeDictionary:(nullable NSDictionary *)dictionary forKey:(nullable id<NSCopying>)aKey;

- (void)setChar:(char)value forKey:(nullable id<NSCopying>)aKey;
- (void)setUnsignedChar:(unsigned char)value forKey:(nullable id<NSCopying>)aKey;
- (void)setShort:(short)value forKey:(nullable id<NSCopying>)aKey;
- (void)setUnsignedShort:(unsigned short)value forKey:(nullable id<NSCopying>)aKey;
- (void)setInt:(int)value forKey:(nullable id<NSCopying>)aKey;
- (void)setUnsignedInt:(unsigned int)value forKey:(nullable id<NSCopying>)aKey;
- (void)setLong:(long)value forKey:(nullable id<NSCopying>)aKey;
- (void)setUnsignedLong:(unsigned long)value forKey:(nullable id<NSCopying>)aKey;
- (void)setLongLong:(long long)value forKey:(nullable id<NSCopying>)aKey;
- (void)setUnsignedLongLong:(unsigned long long)value forKey:(nullable id<NSCopying>)aKey;
- (void)setFloat:(float)value forKey:(nullable id<NSCopying>)aKey;
- (void)setDouble:(double)value forKey:(nullable id<NSCopying>)aKey;
- (void)setBool:(BOOL)value forKey:(nullable id<NSCopying>)aKey;
- (void)setInteger:(NSInteger)value forKey:(nullable id<NSCopying>)aKey NS_AVAILABLE(10_5, 2_0);
- (void)setUnsignedInteger:(NSUInteger)value forKey:(nullable id<NSCopying>)aKey NS_AVAILABLE(10_5, 2_0);

+ (nonnull id)mutableDictionaryWithDictionary:(nonnull NSDictionary *)dictonay;
...
/**
 ...
 @discussion Apple has implemented this method, but did not make it public.
 */
+ (nullable NSMutableDictionary *)dictionaryWithPlistData:(nullable NSData *)plist;
...
/**
 ...
 @return A new dictionary created from the plist string, or nil if an error occurs.
 */
+ (nullable NSMutableDictionary *)dictionaryWithPlistString:(nullable NSString *)plist;
