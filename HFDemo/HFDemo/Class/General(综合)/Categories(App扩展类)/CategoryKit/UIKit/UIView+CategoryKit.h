...
#define XInitViewImplementation \
- (id)init \
{ \
if (self = [super init]) { \
[self setupView]; \
...
@property (nullable, nonatomic, readonly) UINavigationController *navigationViewController;
/**
...
typedef NS_ENUM(NSInteger, JJShakeDirection) {
    JJShakeDirectionHorizontal,
    JJShakeDirectionVertical
};

@interface UIView (JJShake)
/**
 *  @param times          震动的次数
 *  @param speed          震动的速度
 *  @param range          震动的幅度
