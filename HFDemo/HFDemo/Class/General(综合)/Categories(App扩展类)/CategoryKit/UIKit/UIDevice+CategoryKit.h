 ...
 */
typedef NS_OPTIONS(NSUInteger, XNetworkTTrafficType) {
    XNetworkTTrafficTypeWWANSent     = 1 << 0,
    XNetworkTTrafficTypeWWANReceived = 1 << 1,
    XNetworkTTrafficTypeWIFISent     = 1 << 2,
    XNetworkTTrafficTypeWIFIReceived = 1 << 3,
    XNetworkTTrafficTypeAWDLSent     = 1 << 4,
    XNetworkTTrafficTypeAWDLReceived = 1 << 5,
    
    XNetworkTTrafficTypeWWAN = XNetworkTTrafficTypeWWANSent | XNetworkTTrafficTypeWWANReceived,
    XNetworkTTrafficTypeWIFI = XNetworkTTrafficTypeWIFISent | XNetworkTTrafficTypeWIFIReceived,
    XNetworkTTrafficTypeAWDL = XNetworkTTrafficTypeAWDLSent | XNetworkTTrafficTypeAWDLReceived,
    
    XNetworkTTrafficTypeALL = XNetworkTTrafficTypeWWAN |
                              XNetworkTTrafficTypeWIFI |
                              XNetworkTTrafficTypeAWDL,
};
...
/**
 ...
 Usage:
     ...
     uint64_t bytes = [[UIDevice currentDevice] getNetworkTrafficBytes:XNetworkTTrafficTypeALL];
