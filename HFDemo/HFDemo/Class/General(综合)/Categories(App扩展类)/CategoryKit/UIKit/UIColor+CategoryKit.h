...
extern void X_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
                      CGFloat *h, CGFloat *s, CGFloat *l);

extern void X_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
                      CGFloat *r, CGFloat *g, CGFloat *b);

extern void X_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
                      CGFloat *h, CGFloat *s, CGFloat *v);

extern void X_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                      CGFloat *r, CGFloat *g, CGFloat *b);

extern void X_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
                       CGFloat *c, CGFloat *m, CGFloat *y, CGFloat *k);

extern void X_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                       CGFloat *r, CGFloat *g, CGFloat *b);

extern void X_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
                      CGFloat *hh, CGFloat *ss, CGFloat *ll);

extern void X_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
