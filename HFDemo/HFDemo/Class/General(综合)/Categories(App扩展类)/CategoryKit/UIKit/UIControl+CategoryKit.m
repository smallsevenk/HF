...
@interface _XUIControlBlockTarget : NSObject
...
@implementation _XUIControlBlockTarget
...
- (void)removeAllTargets {
    ...
    [[self _X_allUIControlBlockTargets] removeAllObjects];
}
...
- (void)addBlockForControlEvents:(UIControlEvents)controlEvents
    ...
    _XUIControlBlockTarget *target = [[_XUIControlBlockTarget alloc]
                                       initWithBlock:block events:controlEvents];
    [self addTarget:target action:@selector(invoke:) forControlEvents:controlEvents];
    NSMutableArray *targets = [self _X_allUIControlBlockTargets];
...
- (void)removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
    ...
    for (_XUIControlBlockTarget *target in targets) {
...
- (NSMutableArray *)_X_allUIControlBlockTargets {
