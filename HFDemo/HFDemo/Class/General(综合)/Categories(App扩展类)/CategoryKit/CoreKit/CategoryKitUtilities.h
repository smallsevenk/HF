...
CGContextRef _Nullable XCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable XCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);



/// Get main screen's scale.
CGFloat XScreenScale();
 ...
 */
CGAffineTransform XCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]);

/// Get the transform which can converts a point from the coordinate system of a given view to another.
CGAffineTransform XCGAffineTransformGetFromViews(UIView *from, UIView *to);
...
UIViewContentMode XCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *XUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect XCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale XScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize XScreenSize()
#endif

// main screen's width (portrait)
#ifndef SCREEN_WIDTH
#define SCREEN_WIDTH XScreenSize().width
#endif

// main screen's height (portrait)
#ifndef SCREEN_HEIGHT
#define SCREEN_HEIGHT XScreenSize().height
#endif
