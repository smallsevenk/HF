...
@implementation CALayer (CategoryKit)
...
- (UIViewContentMode)contentMode {
    return XCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = XUIViewContentModeToCAGravity(contentMode);
}
